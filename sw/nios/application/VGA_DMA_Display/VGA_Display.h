...
#define VGA_DISPLAY_SYNC_V_REG         (2 * 4)
#define VGA_DISPLAY_SYNC_H_REG         (3 * 4)
#define VGA_DISPLAY_VISIBLE_AREA_V_REG (4 * 4)
#define VGA_DISPLAY_VISIBLE_AREA_H_REG (5 * 4)
#define VGA_SYNC_PULSE_V_REG           (6 * 4)
#define VGA_SYNC_PULSE_H_REG           (7 * 4)
...
void VGA_Display_changeSyncHorizontal(alt_u32 BASE, alt_u16 visible_area, alt_u16 front_porch,
		alt_u16 sync_pulse, alt_u16 back_porch);
